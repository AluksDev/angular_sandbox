...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  protected themeService = inject(FuseThemeService);
  ...
  ngOnInit(): void {
    ...
    combineLatest<[any, BreakpointState]>([
      ...
      .pipe(
        ...
        map(([config, mql]: [any, BreakpointState]) => {
          const options = {
    ...
    this._router.events
      .pipe(
        ...
        tap((newUrl: NavigationStart) => {
          // const newPath = newUrl.url?.split('#')[0] || null;
          // const oldPath = this._router.url.split('#')[0] || undefined;
          // if (newPath !== oldPath) {
          //   if (newPath) {
          //     // Only restart the color when out of place, event and entity areas
          //     if (
          //       newPath.indexOf('/dashboard') < 0 ||
          //       newPath.indexOf('/event') < 0 ||
          //       newPath.indexOf('/entity') < 0
          //     ) {
