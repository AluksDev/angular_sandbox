...
export class QuickChatComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  readonly messageInput = viewChild<ElementRef>('messageInput');
  chat: Chat;
  chats: Chat[];
  opened = false;
  selectedChat: Chat;
  ...
  private _resizeMessageInput(): void {
    ...
    this._ngZone.runOutsideAngular(() => {
      setTimeout(() => {
        ...
        messageInput.nativeElement.style.height = 'auto';

        // Get the scrollHeight and subtract the vertical padding
        messageInput.nativeElement.style.height = `${messageInput.nativeElement.scrollHeight}px`;
      });
    });
  }
