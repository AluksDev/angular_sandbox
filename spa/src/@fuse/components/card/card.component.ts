...
import { Component, HostBinding, input, OnChanges, signal, SimpleChanges, ViewEncapsulation } from '@angular/core';
...
export class FuseCardComponent implements OnChanges {
  ...
  face = input<FuseCardFace>('front');
  flippableInput = input(false);
  flippable = signal(false);
